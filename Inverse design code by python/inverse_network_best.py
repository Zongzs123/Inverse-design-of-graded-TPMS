...
for i in range(0, 6):
    def train(args):
        ...
        train_result = inverse_model.fit(inputs, targets, epochs=args.epochs, batch_size=args.batch_size,
        ...
        model_loc = os.path.join(base_dir, 'inverse'+str(i)+'.keras')
    ...
    if __name__ == '__main__':
        ...
        args.epochs = 300
        args.batch_size = 256
        args.run_name = "./inverse_network_mlp/"
        train(args)
